...
<head>
    ...
    <title>{{ config('app.name') }} - Ticket status</title>
    <style>
        body {
...
<body>
    <div class="card">
        ...
        <p>Your ticket <strong>{{ $ticket->ticket_number }}</strong> has been updated. Keep an eye on the dashboard for the latest progress.</p>
        ...
        <div class="footer">
            ...
            This update was sent automatically so you can stay in sync.
        </div>
    </div>
</body>
</html>
